...
urlpatterns = [
    ...
    path('exportar_comisiones_etnico_view', views.ExportarComisionesEtnicoView.as_view(),
         name='exportar_comisiones_etnico_view'),
    path('exportar_comisiones_fieldex_view', views.ExportarComisionesFieldexView.as_view(),
         name='exportar_comisiones_fieldex_view'),
    path('exportar_comisiones_juan_view', views.ExportarComisionesJuanView.as_view(),
         name='exportar_comisiones_juan_view'),
    ...
    path('actualizar-tasas/', views.actualizar_tasas, name='actualizar_tasas'),
