...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('semana', models.IntegerField(blank=True, editable=False, null=True, verbose_name='Semana')),
                ...
                ('tasa_representativa_usd_diaria', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=10, null=True, verbose_name='$TRM Oficial')),
                ...
                ('estado_cancelacion', models.CharField(choices=[('sin_solicitud', 'Sin solicitud'), ('pendiente', 'Pendiente'), ('autorizado', 'Autorizado'), ('no_autorizado', 'No Autorizado')], default='sin_solicitud', max_length=20, verbose_name='Estado Cancelación')),
                ...
                ('eta_real', models.DateTimeField(blank=True, null=True, verbose_name='Real Final Eta')),
