                ...
                <div>
                    <div>
                        <div className="flex items-center gap-2">
                            ...
                            <h1 className="text-2xl font-bold tracking-tight text-slate-900 font-plus-jakarta">Gestión de Referencias</h1>
                        </div>
                        <p className="text-muted-foreground text-sm mt-1">Administración maestra de productos por exportador</p>
                    </div>
                </div>
