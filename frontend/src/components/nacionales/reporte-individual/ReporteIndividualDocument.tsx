...
const ReporteIndividualDocument: React.FC<ReporteIndividualDocumentProps> = ({ data }) => {
    ...
    return (
        <div
            className="bg-white mx-auto font-sans text-gray-800 w-full"
            style={{
                padding: '40px',
        ...
        >
            <style jsx>{`
                    /* Using system fonts to avoid external dependencies */
