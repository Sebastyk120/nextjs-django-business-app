    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                icon: Users,
                submenu: [
                    { title: "Transferencia Prov.", href: "/nacionales/transferencias" },
                    { title: "Envío Reporte Ind.", href: "/nacionales/reporte-individual" },
                    { title: "Resumen Reportes", href: "/nacionales/resumen-reportes" },
                    { title: "Estado Cuenta", href: "/nacionales/estado-cuenta" },
                ],
            },
        ],
    },
