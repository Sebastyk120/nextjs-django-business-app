...
urlpatterns = [
    ...
    path('inventario_bodega_ci_dorado', views.InventarioBodegaCiDoradoListView.as_view(), name='inventario_bodega_ci_dorado'),
    ...
    path('recibo_items_list_ci_dorado', views.ItemListViewCiDorado.as_view(), name='reciboitemslistci_dorado'),
    path('recibo_items_create_juan', views.ItemCreateViewJuan.as_view(), name='reciboitemscreatejuan'),
    path('recibo_items_create_ci_dorado', views.ItemCreateViewCiDorado.as_view(), name='reciboitemscreateci_dorado'),
    ...
    path('exportar_inventario_ci_dorado', views.exportar_inventario_ci_dorado, name='exportar_inventario_ci_dorado'),
    ...
    path('exportar_items_ci_dorado', views.exportar_items_ci_dorado, name='exportar_items_ci_dorado'),
